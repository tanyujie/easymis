...
<body class="site-contabs-open site-menubar-unfold">
		...
		<div class="navbar-header">
			...
			<div class="navbar-brand navbar-brand-center site-gridmenu-toggle"
				...
				<img class="navbar-brand-logo visible-lg visible-xs navbar-logo"
					...
					src="<%=path%>/public/images/logo-white-min.svg" title="Admui">
			</div>
		</div>
			...
			<div class="collapse navbar-collapse navbar-collapse-toolbar"
				...
				<ul class="nav navbar-toolbar navbar-left">
					<li class="hidden-float"><a data-toggle="menubar"
						class="hidden-float hided unfolded" href="javascript:;"
					...
					<li class="navbar-menu nav-tabs-horizontal nav-tabs-animate"
						...
						<ul class="nav navbar-toolbar nav-tabs" role="tablist" style="margin-top: 0px;padding-top:0px;">
							...
							<li role="presentation" class=""><a data-toggle="tab"
								...
								role="tab" aria-expanded="false"> <i class="icon fa-bars"></i>
									<span>菜单示例</span>
							</a></li>
							...
							<li role="presentation" class="" style="display: none;"><a
								...
								aria-expanded="false"> <i class="fa fa-settings"></i> <span>系统管理</span>
							</a></li>
							...
							<li class="dropdown" id="admui-navbarSubMenu"><a
								...
								<ul class="dropdown-menu" role="menu">
									<li role="presentation" class="" style="display: block;">
									...
									<li class="no-menu" role="presentation"><a
										href="/system/menu" target="_blank" role="menuitem"
				...
				<ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
					<li class="dropdown" id="admui-navbarMessage"><a
						...
						<ul class="dropdown-menu dropdown-menu-right dropdown-menu-media"
							...
							<li class="dropdown-menu-footer" role="presentation"><a
								href="/system/account/message" target="_blank" data-pjax="">
					...
					<li class="hidden-xs" id="admui-navbarDisplay"
						...
						href="/system/settings/display" target="_blank" data-pjax="">
					...
					<li class="hidden-xs" id="admui-demo-app" data-toggle="tooltip"
						...
						<ul
							...
							<li role="presentation"><a
								...
								role="menuitem"><i class="icon fa-windows"></i> Windows 版</a></li>
							<li role="presentation"><a
								href="http://dl.admui.com/app/mac/admui-demo.zip"
								role="menuitem"><i class="icon fa-apple"></i> MacOS 版</a></li>
						</ul>
					</li>
					...
					<li><a class="fa fa-sign-out" id="admui-signOut" data-ctx=""
						data-user="9" href="/system/logout" role="button"> <span
						...
						<div>
							<ul class="site-menu">
								...
								<li class="site-menu-item has-sub"><a href="javascript:;"><i
										class="site-menu-icon fa-laptop" aria-hidden="true"></i><span
										class="site-menu-title">布局</span><span class="site-menu-arrow"></span></a>
									<ul class="site-menu-sub">
										...
										<li class="site-menu-item has-sub "><a
											href="javascript:;"> <span class="site-menu-title">栅格</span><span
												class="site-menu-arrow"></span></a>
											<ul class="site-menu-sub">
												<!-- 五级菜单 -->

												<li class="site-menu-item "><a data-pjax=""
													href="/components/layouts/grids" target="_blank"> <span
														class="site-menu-title">基本栅格</span>
												</a></li>

												<li class="site-menu-item "><a data-pjax=""
													href="/components/layouts/layout-grid" target="_blank">
										...
										<li class="site-menu-item has-sub "><a
											...
											<ul class="site-menu-sub">
												...
												<li class="site-menu-item "><a data-pjax=""
													href="/components/layouts/headers" target="_blank"> <span
														class="site-menu-title">普通</span>
												</a></li>

												<li class="site-menu-item "><a data-pjax=""
													href="/components/layouts/bordered-header" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/layouts/panel-transition" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/layouts/boxed" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/layouts/page-aside" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/layouts/two-columns" target="_blank"> <span
								...
								<li class="site-menu-item has-sub"><a href="javascript:;"><i
										class="site-menu-icon fa-cube" aria-hidden="true"></i><span
										class="site-menu-title">基本</span><span class="site-menu-arrow"></span></a>
									<ul class="site-menu-sub">
										<!-- 四级菜单 -->
										...
										<li class="site-menu-item has-sub "><a
											...
											<ul class="site-menu-sub">
												...
												<li class="site-menu-item "><a data-pjax=""
													href="/components/basic/panel/structure" target="_blank">
														<span class="site-menu-title">面板结构</span>
												</a></li>

												<li class="site-menu-item "><a data-pjax=""
													href="/components/basic/panel/actions" target="_blank">
														<span class="site-menu-title">面板操作</span>
												</a></li>

												<li class="site-menu-item "><a data-pjax=""
													href="/components/basic/panel/portlets" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/buttons" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/icons" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/dropdowns" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/list" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/tooltip-popover" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/modals" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/tabs-accordions" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/images" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/badges-labels" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/carousel" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/typography" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/progress-bars" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/colors" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/basic/utilities" target="_blank"> <span
								...
								<li class="site-menu-item has-sub"><a href="javascript:;"><i
										class="site-menu-icon fa-cubes" aria-hidden="true"></i><span
										class="site-menu-title">进阶</span><span class="site-menu-arrow"></span></a>
									<ul class="site-menu-sub">
										<!-- 四级菜单 -->


										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/tour" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/animation" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/highlight" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/lightbox" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/scrollbar" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/rating" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/context-menu" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/alertify" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/masonry" target="_blank"> <span
										...
										<li class="site-menu-item has-sub "><a
											...
											<ul class="site-menu-sub">
												...
												<li class="site-menu-item "><a data-pjax=""
													href="/components/advanced/tree/jstree" target="_blank">
														<span class="site-menu-title">JsTree</span>
												</a></li>

												<li class="site-menu-item "><a data-pjax=""
													href="/components/advanced/tree/treeview" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/toastr" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/sortable-nestable" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/advanced/bootbox-sweetalert"
								...
								<li class="site-menu-item has-sub"><a href="javascript:;"><i
										class="site-menu-icon fa-plug" aria-hidden="true"></i><span
										class="site-menu-title">组件</span><span class="site-menu-arrow"></span></a>
									<ul class="site-menu-sub">
										<!-- 四级菜单 -->


										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/alerts" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/ribbon" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/pricing-tables" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/overlay" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/cover" target="_blank"> <span
										...
										<li class="site-menu-item has-sub "><a
											...
											<ul class="site-menu-sub">
												...
												<li class="site-menu-item "><a data-pjax=""
													href="/components/structure/timeline/simple"
													target="_blank"> <span class="site-menu-title">简单时间轴</span>
												</a></li>

												<li class="site-menu-item "><a data-pjax=""
													href="/components/structure/timeline/icons" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/step" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/comments" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/media" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/chat" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/testimonials" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/nav" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/navbars" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/blockquotes" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/pagination" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/structure/breadcrumbs" target="_blank">
								...
								<li class="site-menu-item has-sub"><a href="javascript:;"><i
										class="site-menu-icon fa-puzzle-piece" aria-hidden="true"></i><span
									...
									<ul class="site-menu-sub">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/widgets/statistics" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/widgets/data" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/widgets/blog" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/widgets/chart" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/widgets/social" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/components/widgets/weather" target="_blank"> <span
					...
					<div class="tab-pane animation-fade height-full "
						...
						<div>
							<ul class="site-menu">
								...
								<li class="site-menu-item has-sub "><a href="javascript:;"><i
										class="site-menu-icon fa-home" aria-hidden="true"></i><span
									...
									<ul class="site-menu-sub">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/home/index-v1" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/home/index-v2" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/home/ecommerce" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/home/analytics" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/home/team" target="_blank"> <span
								...
								<li class="site-menu-item has-sub "><a href="javascript:;"><i
										class="site-menu-icon fa-files-o" aria-hidden="true"></i><span
									...
									<ul class="site-menu-sub">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/general/blank" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/general/faq" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/general/gallery-grid" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/general/search-result" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/general/user" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/general/email" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/general/code-editor" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax="" href="/error"
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/noauth" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/maintenance" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/locked" target="_blank"> <span
								...
								<li class="site-menu-item has-sub "><a href="javascript:;"><i
										class="site-menu-icon fa-group" aria-hidden="true"></i><span
									...
									<ul class="site-menu-sub">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/team/calendar" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/team/notebook" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/team/taskboard" target="_blank"> <span
										...
										<li class="site-menu-item has-sub "><a
											...
											<ul class="site-menu-sub">
												...
												<li class="site-menu-item "><a data-pjax=""
													href="/pages/team/documents/articles" target="_blank">
														<span class="site-menu-title">列表</span>
												</a></li>

												<li class="site-menu-item "><a data-pjax=""
													href="/pages/team/documents/categories" target="_blank">
														<span class="site-menu-title">分类</span>
												</a></li>

												<li class="site-menu-item "><a data-pjax=""
													href="/pages/team/documents/article" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/team/forum" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/team/message" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/team/mailbox" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/pages/team/media" target="_blank"> <span
										...
										<li class="site-menu-item has-sub "><a
											...
											<ul class="site-menu-sub">
												...
												<li class="site-menu-item "><a data-pjax=""
													href="/pages/team/projects" target="_blank"> <span
														class="site-menu-title">项目列表 01</span>
												</a></li>

												<li class="site-menu-item "><a data-pjax=""
													href="/pages/team/work" target="_blank"> <span
					...
					<div class="tab-pane animation-fade height-full "
						...
						<div>
							<ul class="site-menu">
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/tables/basic/index" target="_blank"> <i
										class="site-menu-icon fa-table" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/tables/treegrid/index" target="_blank"> <i
										class="site-menu-icon fa-bars" aria-hidden="true"></i><span
								...
								<li class="site-menu-item has-sub "><a href="javascript:;"><i
										class="site-menu-icon fa-list-alt" aria-hidden="true"></i><span
									...
									<ul class="site-menu-sub">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/tables/data-tables/basic-init/index" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/tables/data-tables/advanced-init/index"
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/tables/data-tables/data-sources/index" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/tables/data-tables/api/index" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/tables/data-tables/ajax/index" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/tables/data-tables/server-side/index" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/tables/data-tables/plug-ins/index" target="_blank">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/tables/data-tables/others/index" target="_blank">
					...
					<div class="tab-pane animation-fade height-full "
						...
						<div>
							<ul class="site-menu">
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/forms/general" target="_blank"> <i
										class="site-menu-icon fa-circle-o" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/forms/material" target="_blank"> <i
										class="site-menu-icon fa-google" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/forms/advanced" target="_blank"> <i
										class="site-menu-icon fa-toggle-off" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/forms/layouts" target="_blank"> <i
										class="site-menu-icon fa-indent" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/forms/wizard" target="_blank"> <i
										class="site-menu-icon fa-arrow-right" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/forms/validation" target="_blank"> <i
										class="site-menu-icon fa-check-square-o" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/forms/masks" target="_blank"> <i
										class="site-menu-icon fa-at" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/forms/editable" target="_blank"> <i
										class="site-menu-icon fa-edit" aria-hidden="true"></i><span
								...
								<li class="site-menu-item has-sub "><a href="javascript:;"><i
									...
									<ul class="site-menu-sub">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/forms/editor/summernote" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/forms/editor/markdown" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/forms/editor/ace" target="_blank"> <span
												class="site-menu-title">代码编辑器</span>
										</a></li>
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/forms/image-cropping" target="_blank"> <i
										class="site-menu-icon fa-cut" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/forms/dropify" target="_blank"> <i
										class="site-menu-icon fa-cloud-upload" aria-hidden="true"></i><span
					...
					<div class="tab-pane animation-fade height-full "
						...
						<div>
							<ul class="site-menu">
								...
								<li class="site-menu-item has-sub "><a href="javascript:;"><i
										class="site-menu-icon fa-pie-chart" aria-hidden="true"></i><span
									...
									<ul class="site-menu-sub">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/charts/chartjs" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/charts/gauges" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/charts/flot" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/charts/peity" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/charts/sparkline" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/charts/morris" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/charts/chartist" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/charts/rickshaw" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/charts/c3" target="_blank"> <span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/charts/echarts" target="_blank"> <i
										class="site-menu-icon fa-area-chart" aria-hidden="true"></i><span
							...
							<ul class="site-menu">
								...
								<li class="site-menu-item has-sub "><a href="javascript:;"><i
									...
									<ul class="site-menu-sub">
										...
										<li class="site-menu-item "><a data-pjax="" href="/menu"
										...
										<li class="site-menu-item has-sub "><a
											href="javascript:;"> <span class="site-menu-title">二级菜单
													03</span><span class="site-menu-arrow"></span></a>
											<ul class="site-menu-sub">
												<!-- 五级菜单 -->

												<li class="site-menu-item "><a data-pjax=""
													href="/menu" target="_blank"> <span
								...
								<li class="site-menu-item "><a data-pjax="" href="#"
									target="_blank"> <i class="site-menu-icon fa-bars"
					...
					<div class="tab-pane animation-fade height-full "
						...
						<div>
							<ul class="site-menu">
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/system/menu" target="_blank"> <i
										class="site-menu-icon fa-bars" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/system/user" target="_blank"> <i
										class="site-menu-icon fa-street-view" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/system/log" target="_blank"> <i
										class="site-menu-icon fa-file-text-o" aria-hidden="true"></i><span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/system/blacklist" target="_blank"> <i
										class="site-menu-icon fa-shield" aria-hidden="true"></i><span
								...
								<li class="site-menu-item has-sub "><a href="javascript:;"><i
										class="site-menu-icon fa-gear" aria-hidden="true"></i><span
									...
									<ul class="site-menu-sub">
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/system/settings/display" target="_blank"> <span
										...
										<li class="site-menu-item "><a data-pjax=""
											href="/system/settings/log" target="_blank"> <span
								...
								<li class="site-menu-item "><a data-pjax=""
									href="/system/account" target="_blank"> <i
										class="site-menu-icon fa-key" aria-hidden="true"></i><span
	...
	<nav class="site-contabs" id="admui-siteConTabs">
		...
		<div class="contabs-scroll pull-left">
			<ul class="nav con-tabs">
				<li class="active"><a data-pjax="" href="/home" rel="contents"><span>首页</span></a>
				</li>
			</ul>
		</div>
		<div class="btn-group pull-right">
			...
			<ul class="dropdown-menu dropdown-menu-right"
				...
				<li class="reload-page" role="presentation"><a
					href="javascript:;" role="menuitem"><i class="fa fa-reload"></i>
						刷新当前</a></li>
				...
				<li class="close-all" role="presentation"><a
					href="javascript:;" role="menuitem"><i class="fa fa-power"></i>
						关闭所有</a></li>
			</ul>
		</div>
	</nav>
				...
				<div class="media account-info">
					<div class="media-left">
						<div class="avatar avatar-online">
							<img src="/public/images/avatar.svg" alt="xiaxuan@admui_demo">
					...
					<div class="media-body">
						...
						<p>
							...
							40048 次登录，上次登录日期：2017-7-26 11:35:19，详细信息请查看 <a data-pjax=""
								href="/account/log" target="_blank">日志</a> ，如果不是您本人登录，请及时 <a
								data-pjax="" href="/account/password" target="_blank">修改密码</a> 。
						</p>
					</div>
	...
	<footer class="site-footer">
		<div class="site-footer-legal">
			上海畅控 &copy; <a href="http://www.admui.com" target="_blank">admui.com</a>
		</div>
		<div class="site-footer-right">
			当前版本：v1.1.0 <a class="margin-left-5" data-toggle="tooltip" title=""
				href="http://www.admui.com/buy" target="_blank"
				data-original-title="升级"> <i class="icon fa-cloud-upload"></i>
			</a>
		</div>
	</footer>
	...
	<!-- 插件 -->
	<script src="<%=path%>/public/plug/jquery-pjax/jquery.pjax.min.js"></script>
	<script
