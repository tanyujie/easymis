...
import cn.easymis.entitys.mybatis.dto.OaAttendDutyDto;
...
public class AppGenCodeMain {
	...
	public void  genFile(Class pojoclass,String filePath){
		...
		if(vo!=null){
			...
			String modelPackage = "cn.easymis.oa.service";
	...
	public String getProjectRoot() {
		 ...
		 path = path.replace("cn/easymis/oa/service/", "");
	...
	public static void main(String[] arg) {
		...
		// 根据pojo对象生成代码
		Class pojoclass = OaAttendDutyDto.class;
