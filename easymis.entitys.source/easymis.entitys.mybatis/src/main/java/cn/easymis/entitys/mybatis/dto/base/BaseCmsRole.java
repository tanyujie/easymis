...
import cn.easymis.entitys.mybatis.dto.CmsRole;
...
public abstract class BaseCmsRole  implements Serializable {
	...
	private java.util.Set<OaUser> users;
	...
	public java.util.Set<OaUser> getUsers() {
		return users;
	}

	public void setUsers(java.util.Set<OaUser> users) {
		this.users = users;
	}
