package cn.easymis.project.service;
...
import cn.easymis.entitys.mybatis.dto.ProjectDto;
...
public class AppGenCodeMain {
	...
	public void  genFile(Class pojoclass,String filePath){
		...
		if(vo!=null){
			...
			String modelPackage = "cn.easymis.project.service";
	...
	public String getProjectRoot() {
		 ...
		 path = path.replace("cn/easymis/project/service/", "");
	...
	public static void main(String[] arg) {
		...
		// 根据pojo对象生成代码
		Class pojoclass = ProjectDto.class;
