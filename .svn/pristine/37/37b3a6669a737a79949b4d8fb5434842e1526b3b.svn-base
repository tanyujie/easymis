...
import cn.easymis.entitys.mybatis.dto.CmsConfig;
import cn.easymis.entitys.mybatis.dto.CmsLog;
import cn.easymis.entitys.mybatis.dto.CmsSite;
import cn.easymis.entitys.mybatis.dto.CmsUserSite;
import cn.easymis.entitys.mybatis.dto.Ftp;

public class BaseCmsSite {
	...
	public void setUserSites(
			java.util.Set<CmsUserSite> userSites) {
