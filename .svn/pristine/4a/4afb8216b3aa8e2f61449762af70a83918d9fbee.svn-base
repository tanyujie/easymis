...
import cn.easymis.entitys.mybatis.dto.base.BaseCmsSite;
...
public class CmsSite extends BaseCmsSite {
	...
	*/}
	...
	public String getFtpUploadId() {
		return ftpUploadId;
	}

	public void setFtpUploadId(String ftpUploadId) {
	...
	public Boolean getMark(){
		return false;//getConfig().getMarkConfig().getOn();
	}
