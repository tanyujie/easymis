...
public class GenerateDataToObjectMain {
	...
	public String getProjectRoot(){
		 ...
		 path = path.replace("com/taier/code/util/main/", "");
	...
	public void generateDataToObject(String packageName,String ModelName ,String tableName,String databaseName,String fileName){
		...
		sb.append("import com.taier.code.util.annotation.GenField; \r\n");
		sb.append("import com.taier.code.util.annotation.GenModel; \r\n");
		sb.append("import com.taier.code.util.annotation.GenTable; \r\n");
		...
		String FilePath  = this.getProjectRoot();
		 ...
		 try {
			File file = genFile.createFile(FilePath+File.separator+packageName.replace(".", "/")+"/entity", fileName+".java");
	...
	public static void main(String[] arg){
		...
		dto.generateDataToObject("com.taier.ierp.main", "FlowTaskStaff", "flow_task_staff", "ierp", "FlowTaskStaff");
