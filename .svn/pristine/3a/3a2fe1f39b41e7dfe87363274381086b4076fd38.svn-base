...
public class GenCodeMain {
	...
	public void  genFile(Class pojoclass,String filePath){
		...
		if(vo!=null){
			...
			if(keyValue!=null){
				...
				String intefaceJavaContent = msu.getModelServiceInterface(modelPackage, pojoClassName, modelName, idValues);
				...
				//service 实现类中的内容
				String implJavaContent = msu.getModelServiceImpl(modelPackage, pojoClassName, modelName, idValues);
	...
	public String getProjectRoot() {
		 ...
		 path = path.replace("cn/easymis/entitys/mybatis/", "");
	...
	public static void main(String[] arg) {
		...
		// 根据pojo对象生成代码
		Class pojoclass = SysFunctionDto.class;
