...
import cn.easymis.entitys.mybatis.dto.HrmResumeDto;
...
public class GenCodeMain {
	...
	public void  genFile(Class pojoclass,String filePath){
		...
		if(vo!=null){
			...
			String modelPackage = "cn.easymis.hrm.service";
	...
	public String getProjectRoot() {
		 ...
		 path = path.replace("cn/easymis/hrm/service/", "");
	...
	public static void main(String[] arg) {
		...
		// 根据pojo对象生成代码
		Class pojoclass = HrmResumeDto.class;
